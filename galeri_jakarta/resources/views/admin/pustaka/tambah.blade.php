...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold mb-0">Tambah Pustaka (Buku)</h3>
            ...
            <div class="col-md-8">
                <div class="card-section">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul" class="form-control" value="{{ old('judul') }}" placeholder="Masukkan judul buku..." required>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Penulis <span class="text-danger">*</span></label>
                            <input type="text" name="penulis" class="form-control" value="{{ old('penulis') }}" placeholder="Nama Penulis..." required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="isbn" class="form-control" value="{{ old('isbn') }}" placeholder="Contoh: 978-602-...">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Deskripsi Buku</label>
                        <textarea name="deskripsi" class="form-control" rows="8" placeholder="Tuliskan deskripsi atau sinopsis buku...">{{ old('deskripsi') }}</textarea>
                    </div>
                </div>
                ...
                <div class="card-section">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="halaman" class="form-control" value="{{ old('halaman') }}" min="1">
                        </div>
                        <div class="col-md-3 mb-3">
                ...
                <div class="card-section">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="kategori" class="form-select" required>
                            ...
                            <option value="Pasar Buku" {{ old('kategori') == 'Pasar Buku' ? 'selected' : '' }}>Pasar Buku</option>
                            <option value="Galeri Buku" {{ old('kategori') == 'Galeri Buku' ? 'selected' : '' }}>Galeri Buku</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="bahasa" class="form-control" value="{{ old('bahasa') ?? 'Indonesia' }}">
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="form-label">Cover Buku (Thumbnail)</label>
                        <input type="file" name="thumbnail" class="form-control" accept="image/*">
                        <small class="text-muted">Format: JPG, PNG, WEBP (Max 2MB)</small>
                    </div>

                    <button type="submit" class="btn btn-dark w-100 text-white fw-bold">Simpan Buku</button>
                </div>
            </div>
        </div>
    </form>
